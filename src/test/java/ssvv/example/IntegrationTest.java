...
public class IntegrationTest {
    ...
    @BeforeEach
    public void setup() {
        this.temaRepo = new TemaXMLRepo("fisiere/test-teme.xml");
        this.studentRepo = new StudentXMLRepo("fisiere/test-studenti.xml");
        this.noteRepo = new NotaXMLRepo("fisiere/test-note.xml");
        ...
        this.service = new Service(
                ...
                new TemaValidator(),
                this.noteRepo,
                new NotaValidator(this.studentRepo, this.temaRepo)
        );
    }
    ...
    public void testAddAssignment() {
        ...
        try {
            ...
            Tema temaRepo = this.temaRepo.findOne("1");
    ...
    public void testAddGrade() {
        ...
        try {
            ...
            Nota notaRepo = this.noteRepo.findOne("1");
    ...
    public void testIntegration() {
        ...
        try {
            ...
            Tema newTema = this.temaRepo.findOne("2");
            Nota newNota = this.noteRepo.findOne("2");
